...
struct fh8626_capabilities fh8626_capabilities_current(void)
{
    ...
    caps.sensor_open_backend = FH8626_CAP_PROVEN;
    ...
    caps.jpeg_snapshot = FH8626_CAP_PROVEN;
    caps.mjpeg = FH8626_CAP_PROVEN;
    caps.audio_rtx_transport = FH8626_CAP_PROVEN;
    caps.audio = FH8626_CAP_PROVEN;
    caps.runtime_audio_reconfigure = FH8626_CAP_PROVEN;
