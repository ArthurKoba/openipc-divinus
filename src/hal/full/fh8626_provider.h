...
enum {
    ...
    FH8626_BLOCKER_AUDIO_EXTERNAL_HELPER = 1u << 3,
    FH8626_BLOCKER_RUNTIME_RECONFIG = 1u << 4,
    FH8626_BLOCKER_SAME_BOOT_TEARDOWN = 1u << 5,
    FH8626_BLOCKER_HARDWARE_ACCEPTANCE = 1u << 6
};

#define FH8626_KERNEL_BLOCKERS \
    (FH8626_BLOCKER_SENSOR_VENDOR_PLUGIN | \
     FH8626_BLOCKER_AUDIO_EXTERNAL_HELPER | \
